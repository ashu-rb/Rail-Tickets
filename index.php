...
<body>
	...
	<div class="wrap">
		<!-- Header -->
		<div class="header">
			<div style="float:left;width:100px; padding-top: 25px;padding-left:25px;}">
		...
		<div class="span12 well">
			<!-- Photos slider -->
			<div id="myCarousel" class="carousel slide" style="width:75%; float:left;margin-bottom:3px;">		
				<div class="carousel-inner">
				<div class="active item"><img src="images\azadi2.jpg" style="width:1000px;height:350px;"/></div>
				<div class="item"><img src="images\sl3-old.jpg" style="width:800px;height:350px;"/> </div>
				<div class="item"><img src="images\sl4.jpg" style="width:600px;height:350px;"/></div>
...
<footer >
		<div style="width:100%;">			
			...
			<p class="text-right text-info">	Designed By : Aayush Patel and Abhijeet Thakur</p>
			</div>
		</div>
		</footer>	
